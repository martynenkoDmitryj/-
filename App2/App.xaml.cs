...
namespace App2
{
    ...
    public sealed partial class App : Application
    {
        ...
        public static Lawyer CurrentLawyer { get; set; }
        public static string FileName { get; set; }
        public static string CurrentWebPage { get; set; }
        public static int CurrentQuestion { get; set; }
        public static List<IPunishment> Punishment = new List<IPunishment>();
        public static bool WasPressed { get; set; }
